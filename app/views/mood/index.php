        ...
        const lineChart = new Chart(lineCtx, {
            ...
            options: {
                ...
                scales: {
                    ...
                    x: {
                        type: 'category', // Ganti dari 'time' ke 'category' agar hanya label input user yang tampil
                        labels: moodData.labels, // Pastikan labels berisi array waktu input user (ISO string)
                        title: {
                            display: true,
                            text: 'Waktu'
                        },
                        ticks: {
                            callback: function(value, index, ticks) {
                                // Ambil label asli dari moodData.labels
                                const rawValue = moodData.labels?.[index] ?? value;
                            ...
                            minRotation: 45,
                            align: "center",
                            autoSkip: false, // Jangan skip agar semua input tampil
                            color: "#333"
                        }
                    }
                },
                plugins: {
                    ...
                    tooltip: {
                        callbacks: {
                            // Format judul di tooltip saat mouse hover
