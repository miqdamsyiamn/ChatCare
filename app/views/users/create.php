...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold ml-4">Tambah Pengguna</h1>
    </div>
        ...
        <div class="p-6">
            <form action="/users/store" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline <?= !empty($password_err) ? 'border-red-500' : '' ?>" required>
