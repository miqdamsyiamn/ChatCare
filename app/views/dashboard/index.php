...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600">Selamat datang kembali, <span class="font-medium"><?php
        ...
        <div class="md:flex">
            <div class="md:flex-shrink-0 bg-gradient-to-br from-[#ff9800] to-[#e65100] p-6 text-white flex items-center justify-center md:w-48">
                <div class="text-center">
                    ...
                    <h3 class="font-bold text-xl"><?php // $_SESSION['name'] ?></h3>
                    <p class="text-white/80 capitalize"><?php // $_SESSION['role'] ?></p>
                </div>
            </div>
            <div class="p-6 md:p-8 md:flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium"><?php // $_SESSION['email'] ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500 mb-1">Bergabung Sejak</p>
                        <p class="font-medium"><?php // date('d F Y', strtotime($_SESSION['created_at'] ?? date('Y-m-d'))) ?></p>
                    </div>
                </div>
